...
public class MergeLeadsPage extends ProjectSpecificMethods {
	...
	public MergeLeadsPage verifyMergeLeadsPage() {
	...
	public MergeLeadsPage selectLeads(String str) throws InterruptedException {
	...
	public MergeLeadsPage confirmAlert() {
	...
	public MergeLeadsPage selectLead(int i) throws InterruptedException {
	...
	public MergeLeadsPage switchWindow() {
		getParentWindow();
	...
	public MergeLeadsPage clickFromLeadToMerge() throws InterruptedException {
		parentWindow = getDriver().getWindowHandle();
		getDriver().findElement(By.xpath("//span[text()='From Lead']/ancestor::tr//img")).click();
		selectLeadToMerge(1);
		return this;
	...
	public MergeLeadsPage clickToLeadToMerge() throws InterruptedException {
